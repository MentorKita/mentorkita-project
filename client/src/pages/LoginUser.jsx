            ...
            <div className="mb-[20px]">
              ...
              <section className="flex justify-center center-items">
                <figure className="bg-gray-200 w-[60px] h-[40px] mx-[10px] rounded flex justify-center items-center">
                  <img
                    src="../../public/images/logo_google.png"
                    alt="google"
                ...
                <figure className="bg-gray-200 w-[60px] h-[40px] mx-[10px] rounded flex justify-center items-center">
                  <img
                    src="../../public/images/logo_fb.png"
                    alt="facebook"
                    className="bg-gray-200 w-[25px] h-[25px]"
                  />
                </figure>
                <figure className="bg-gray-200 w-[60px] h-[40px] mx-[10px] rounded flex justify-center items-center">
                  <img
                    src="../../public/images/logo_apple.png"
                    alt="apple"
                    className="bg-gray-200 w-[25px] h-[25px] rounded"
                  />
                </figure>
              </section>
            </div>
