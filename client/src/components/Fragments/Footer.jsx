...
const Footer = () => {
    return(
        <>
            <div className="bg-white lg:h-[246px]">
                <section className="w-[200px] h-[100px] py-6 flex flex-row mx-auto lg:w-[224px] lg:h-[71px] lg:py-12">
                    <img className="w-[40px] h-[40px] lg:w-[71px] lg:h-[71px] " src="https://s3-alpha-sig.figma.com/img/745f/92ed/644aadfbd63ae1f815f276a605048093?Expires=1713744000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=cMtUBtPjlzKFBgwhlM9jba5OSqEQoHRbkrG5khpKzTViaKCTdNiilM0VzThq3IkD7jngUTDJx2MuZN5q4CT1x5HQaIkE6aF3J31iQ9659f8pQjK0iktQcLsgVOa2XRq8OUu2bGQrFE9oiu~sTSlkMoLIbe9cyuKPp~X6NKIMw~X8H4~myFb2G4evQaSJ9lHLk5Za7d-Xep-jqiefsotJcIWtgFd7rUJ0pC05EN5wguJkIr7zHkdlskuY~ClTTu47nDXysO19qLMKR2azXxeFSIyfWmVa23eOz6~AGD2yDKnLIYhMem8qZnYF1FhFqcT9Hdy9VQOU1kikZ6Xp9yMZXg__" alt="" />
                    <p className="text-blue-900 font-extrabold text-[24px] pt-1 ml-2 lg:leading-[36px]">Mentor <span className="text-blue-400">Kita</span></p>
                </section>
